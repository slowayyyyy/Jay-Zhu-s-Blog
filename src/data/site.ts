...
export const translations = {
	zh: {
		...
		checkins: {
			...
			home: {
			kicker: '个人博客',
			latestTitle: '沿着时间，继续往下读',
			latestIntro: '最近读过的论文、想明白的问题，以及认真生活过的痕迹，都从这里慢慢展开。',
			sidebarTitle: '写在路上',
			sidebarBody: '有些答案来自论文，有些来自一次跑步、一页书，或一个普通的晚上。我想把它们放在一起。',
			featured: '想先与你分享',
			startReading: '读最新一篇',
			latestUpdated: '最近更新',
			statsPosts: '全部文章',
	...
	en: {
		...
		checkins: {
			...
			latestTitle: 'Keep Reading Through Time',
			latestIntro: 'Recent papers, questions worked through, and traces of a life lived with attention unfold from here.',
			sidebarTitle: 'Notes Along the Way',
			sidebarBody: 'Some answers come from papers; others from a run, a page, or an ordinary evening. I want to keep them together.',
			featured: 'A Few Notes to Begin With',
			startReading: 'Read the Latest',
