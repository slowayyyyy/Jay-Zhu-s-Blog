...
![QVHighlights 任务示意 | lg | center](/uploads/moment-detr-wps01.jpg)
...
![QVHighlights 数据集任务标注 | lg | center](/uploads/moment-detr-wps02.jpg)

![Moment 分布统计 | lg | center](/uploads/moment-detr-wps03.jpg)

从上面两张图中也可以印证作者所讲的，作者设计的数据集上面同时支持两项任务，而且moments分布比较均匀，没有出现集中在视频前面的情况。作者还讲了数据集的具体构建细节，这个不是重点就略过了。

![Moment-DETR 整体架构 | lg | center](/uploads/moment-detr-wps04.jpg)
...
![Moment-DETR 性能对比 | lg | center](/uploads/moment-detr-wps09.jpg)
...
![消融实验结果 | lg | center](/uploads/moment-detr-wps10.jpg)

然后还说明了模型的不同预测槽位分化出了不同的分工，对于预测片段的长短和位置都各有偏好，如下图，靠左就是偏向预测开头，往上就是偏向预测更长。

![预测槽位分工可视化 | lg | center](/uploads/moment-detr-wps11.jpg)

最后作者展示了预测的结果与真实情况对比，以及在不同类型的视频下模型的性能对比，如下图。

![预测结果案例对比 | lg | center](/uploads/moment-detr-wps12.jpg)

![不同视频类型性能对比 | lg | center](/uploads/moment-detr-wps13.jpg)
