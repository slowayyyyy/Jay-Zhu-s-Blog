...
export const site = {
  ...
  avatar: new URL(profileConfig.avatar || "/favicon/azure-corridor.svg", siteConfig.site_url).href,
  screenshot: new URL(azureContent.visuals.desktopWallpapers[0]?.crop?.src || "/favicon/azure-corridor.svg", siteConfig.site_url).href,
  email: (profileConfig.links.find((link) => link.url.startsWith("mailto:"))?.url || "").replace(/^mailto:/, ""),
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="mt-1 text-xs text-(--primary) leading-relaxed">请按申请模板发送邮件，由站长确认后添加；本站未启用 AI 自动审核。</p>
            </div>
          </div>
